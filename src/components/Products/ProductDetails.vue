  ...
  <div class="pt-6">
    ...
    <div class="mx-auto mt-6 max-w-2xl sm:px-6 lg:grid lg:max-w-7xl lg:grid-cols-3 lg:gap-x-8 lg:px-8">
      ...
      <div class="hidden lg:grid lg:grid-cols-1 lg:gap-y-8">
        ...
        <div class="aspect-h-2 aspect-w-3 overflow-hidden rounded-lg">
          <img :src="product.attachment_2" 
          alt="Model wearing plain gray basic tee." 
          class="h-full w-full object-cover object-center">
        </div>
      </div>
      <div class="aspect-h-5 aspect-w-4 lg:aspect-h-4 lg:aspect-w-3 sm:overflow-hidden sm:rounded-lg">
        <img :src="product.attachment_3" 
    ...
    <div class="mx-auto max-w-2xl px-4 pb-16 pt-10 sm:px-6 lg:grid lg:max-w-7xl lg:grid-cols-3 lg:grid-rows-[auto,auto,1fr] lg:gap-x-8 lg:px-8 lg:pb-24 lg:pt-16">
      ...
      <div class="mt-4 lg:row-span-3 lg:mt-0">
        ...
        <p class="text-3xl tracking-tight text-gray-900">{{ $toCurrency(product.actual_price) }}</p>
          ...
          <div class="flex items-center">
            <div class="flex items-center">
              ...
              <template v-for="i in 5" :key="i">
                ...
                :class="{'text-gray-900': i <= product.average_review, 'text-gray-200': i > product.average_review}"
                viewBox="0 0 20 20"
                fill="currentColor"
                aria-hidden="true">
            ...
            class="ml-3 text-sm font-medium text-indigo-600 hover:text-indigo-500">{{ product.reviews.length }} reviews</a>
          </div>
        </div>
